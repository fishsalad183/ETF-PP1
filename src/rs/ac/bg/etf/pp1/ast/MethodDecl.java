...
public class MethodDecl implements SyntaxNode {
    ...
    public MethodDecl (OptargOption OptargOption, ReturnType ReturnType, MethodName MethodName, FormPars FormPars, VarDeclList VarDeclList, StatementList StatementList) {
